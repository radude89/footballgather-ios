//
//  GetPlayersForGatherServiceTests.swift
//  FootballGatherTests
//
...
final class GetPlayersForGatherServiceTests: XCTestCase {
    ...
    func test_request_completesSuccessfully() {
        ...
        service.getPlayers(forGatherId: ModelsMock.gatherUUID) { result in
            switch result {
